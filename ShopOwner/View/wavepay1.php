        ...
        <div class="card">
            ...
            <form action="../Controller/waveOTPcontroller.php" method="post">
                <!-- <div class=" text-center mt-4">
                    <input type="text" name="useremail" id="" placeholder="email address" class="phone">
                </div> -->

                <div class="fouth mt-3">
                    <input type="text" name="useremail" id="" placeholder="email address" class="pas ms-4">
                    <div class="otpBtn">
            ...
            <form action="../Controller/wave1confirmController.php" method="post">
                ...
                <div class="text-center mt-2">
                    <input type="password" name="pwd" id="" placeholder="One time password" class="phone ms-4">
                </div>
