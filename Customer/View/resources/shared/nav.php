...
<div class="position-absolute top-0 p-5  sideBar d-flex flex-column justify-content-center align-items-center ">
  ...
  <ul class=" slideBar">
    <li class="nav-item">
      <a class="nav-link navtitle pb-2" aria-current="page" href="./h.php">HOME</a>
    </li>
    <li class="nav-item">
      <a class="nav-link navtitle my-5 pb-2" href="./shop.php">SHOP</a>
    </li>
    <li class="nav-item ">
      <a class="nav-link navtitle pb-2" href="./promotion.php">PROMOTIONS</a>
    </li>
    <li class="nav-item">
