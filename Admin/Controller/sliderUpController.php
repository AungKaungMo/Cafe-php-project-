...
if(isset($_POST["saveChange"])){
    ...
    if ($file != []){
        ...
        if (move_uploaded_file($location1, "../../Storages/adminslider/" . $file[0]['name'])) {
            $finalquery = $query . $query1 . $query2 . $query3 . $query4 . $queryend;
            $sql = $pdo->prepare(
                $finalquery
            );
        ...
        (move_uploaded_file($location2, "../../Storages/adminslider/" . $file[1]['name'])) {
            $finalquery = $query . $query1 . $query2 . $query3 . $query4 . $queryend;
            $sql = $pdo->prepare(
                $finalquery
            );
        ...
        (move_uploaded_file($location3, "../../Storages/adminslider/" . $file[2]['name'])) {
            $finalquery = $query . $query1 . $query2 . $query3 . $query4 . $queryend;
            $sql = $pdo->prepare(
                $finalquery
            );
